...
* количество, сделанных вами ошибок (0)
* максимальное число возможных ошибок (7)
...
* достроит "виселицу" на 1 шаг вперед
...
4. Загадываемое Слово программа выбирает случайным образом из всех слов из файла data/words.txt
### Разработка
...
3. Выполнение поставленной задачи коснулбыло обеспечено изменениями в классе Game:
